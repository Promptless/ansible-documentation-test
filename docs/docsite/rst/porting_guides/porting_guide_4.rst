...
- Removed the deprecated ``STRING_CONVERSION_ACTION`` feature, which was introduced in version 2.8. This feature allowed users to specify actions for string conversion of module parameter values. There is no alternative mechanism provided. (https://github.com/ansible/ansible/issues/84220)
