...
- Removed the deprecated `STRING_CONVERSION_ACTION` feature, which was introduced in Ansible 2.8 and deprecated since 2.19. This feature allowed users to specify actions for string conversion of module parameters. There is no alternative at the moment. (https://github.com/ansible/ansible/issues/84220)
