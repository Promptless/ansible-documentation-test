...
Type: ``bool``_ansible_string_conversion_action
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
This argument provided instructions about what modules should do after the values of the user-specified module parameters were converted to strings. This option has been removed as of version 2.19. For more details, see the :ref:`STRING_CONVERSION_ACTION` configuration option.
